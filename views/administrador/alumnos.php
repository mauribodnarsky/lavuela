                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4" style="background-color: #01a9b4 !important;">
                                    <div class="card-body text-center">ALUMNOS INACTIVOS <strong><?php echo $alumnosinactivos;?></strong></div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4" style="background-color:#ff2e34 !important;">
                                    <div class="card-body text-center">ALUMNOS ACTIVOS <strong><?php echo $alumnosactivos;?></strong></div>
                                </div>
                            </div>
                         
                            <div class="col-xl-6 col-md-6">
                                <div class="card bg-danger text-white mb-4" style="background-color: #ffcd00 !important;">
                                    <button data-toggle="modal" class="btn btn-success" style="background-color: #ffcd00 !important;border-color: #ffcd00 !important;" data-target="#nuevoalumno">+ ALUMNO</button>
                                </div>
                            </div>
                        </div>
                        <div id="layoutSidenav_content">
                                ...
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="p-2 m-2">DNI</th>
                                            <th class="p-2 m-2">ESTADO</th>
                                            <th class="p-2 m-2">FECHA INSCRIPCIÓN</th>
                                            <th class="p-2 m-2">FECHA NACIMIENTO</th>
                                            <th class="p-2 m-2">TELEFONO</th>
                                            <th class="p-2 m-2">CORREO</th>
                                            <th class="p-2 m-2">ACCIÓN</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                ...
                <?php if(isset($alumnos)):?>
                    <?php foreach($alumnos as $alumno):?>
                                        ...
                                        <tr class="my-2 text-center blockquote">
                                            ...
                                            <td>
                                                <?php echo "<button class=\" btn btn-success px-2 py-1 my-3 \" onclick=\"editaralumno('".$alumno['id']."','".$alumno['nombre']."','".$alumno['ultimo_pago']."','".$alumno['estado']."','".$alumno['fecha_inscripcion']."','".$alumno['fecha_nacimiento']."','".$alumno['email']."','".$alumno['telefono']."','".$alumno['dni']."','".$alumno['estado']."')\" style=\"border-radius:4px !important;\">" ;?>
